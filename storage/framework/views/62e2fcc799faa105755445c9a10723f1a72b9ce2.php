...
} elseif ($_instance->childHasBeenRendered('2FHimWM')) {
    $componentId = $_instance->getRenderedChildComponentId('2FHimWM');
    $componentTag = $_instance->getRenderedChildComponentTagName('2FHimWM');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('2FHimWM');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('2FHimWM', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH D:\manajemen-surat\vendor\filament\filament\src\/../resources/views/components/layouts/card.blade.php ENDPATH**/ ?>